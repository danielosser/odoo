...
class MassMailing(models.Model):
    ...
    def _process_mass_mailing_queue(self):
        ...
        if not self.env['ir.config_parameter'].sudo().get_param('mass_mailing.no_mass_mailing_reports'):
    ...
    def _get_unsubscribe_token(self):
        ...
        """
        return tools.hmac(self.env(su=True), 'mailing-report-unsubscribe', self.env.user.id)
    ...
    def _action_send_statistics(self):
        ...
        for mailing in self:
            ...
            if self.env.user.has_group('mass_mailing.group_mass_mailing_user'):
                rendering_data['mailing_off_token'] = self._get_unsubscribe_token(),
