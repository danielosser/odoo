...
def _check_with_xsd(tree_or_str, stream, env=None):
    ...
    :param tree_or_str: representation of the tree to be checked
    :type tree_or_str: etree._Element | str
    :param stream: the byte stream used to build the XSD schema.
        If env is given, it can also be the name of an attachment in the filestore
    :type stream: io.IOBase | str
