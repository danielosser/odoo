    ...
    def create(self, vals_list):
        ...
        for package_level, vals in zip(package_levels, vals_list):
            if vals.get('location_dest_id'):
                package_level.mapped('move_line_ids').write({'location_dest_id': vals['location_dest_id']})
                package_level.mapped('move_ids').write({'location_dest_id': vals['location_dest_id']})
