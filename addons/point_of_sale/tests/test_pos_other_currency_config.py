...
class TestPoSOtherCurrencyConfig(TestPoSCommon):
    ...
    def test_01_check_product_cost(self):
        ...
        self.assertAlmostEqual(self.config.pricelist_id.get_product_price(self.product1, 1), 5.00)
        self.assertAlmostEqual(self.config.pricelist_id.get_product_price(self.product2, 1), 12.99)
        self.assertAlmostEqual(self.config.pricelist_id.get_product_price(self.product3, 1), 15.00)
        self.assertAlmostEqual(self.config.pricelist_id.get_product_price(self.product4, 1), 50)
        self.assertAlmostEqual(self.config.pricelist_id.get_product_price(self.product5, 1), 100)
        self.assertAlmostEqual(self.config.pricelist_id.get_product_price(self.product6, 1), 22.65)
        self.assertAlmostEqual(self.config.pricelist_id.get_product_price(self.product7, 1), 3.50)
    ...
    def test_02_orders_without_invoice(self):
        ...
        self._run_test({
            ...
            'orders': [
                ...
                {'product_quantity_pairs': [(self.product1, 5), (self.product2, 5)], 'uid': '00100-010-0002'},
                {'product_quantity_pairs': [(self.product2, 5), (self.product3, 5)], 'payments': [(self.bank_pm2, 139.95)], 'uid': '00100-010-0003'},
            ],
    ...
    def test_03_orders_with_invoice(self):
        ...
        self._run_test({
            ...
            'orders': [
                {'product_quantity_pairs': [(self.product1, 10), (self.product2, 10), (self.product3, 10)], 'uid': '00100-010-0001'},
                {'product_quantity_pairs': [(self.product1, 5), (self.product2, 5)], 'is_invoiced': True, 'customer': self.customer, 'uid': '00100-010-0002'},
                {'product_quantity_pairs': [(self.product2, 5), (self.product3, 5)], 'payments': [(self.bank_pm2, 139.95)], 'is_invoiced': True, 'customer': self.customer, 'uid': '00100-010-0003'},
            ],
            'before_closing_cb': _before_closing_cb,
            'journal_entries_before_closing': {
                '00100-010-0002': {
    ...
    def test_04_anglo_saxon_products(self):
        ...
        self._run_test({
            ...
            'orders': [
                {'product_quantity_pairs': [(self.product4, 7), (self.product5, 7)], 'uid': '00100-010-0001'},
                {'product_quantity_pairs': [(self.product5, 6), (self.product4, 6), (self.product6, 49)], 'uid': '00100-010-0002'},
                {'product_quantity_pairs': [(self.product5, 2), (self.product6, 13)], 'uid': '00100-010-0003'},
                {'product_quantity_pairs': [(self.product6, 1)], 'uid': '00100-010-0004'},
            ],
            'journal_entries_before_closing': {},
            'journal_entries_after_closing': {
                'session_journal_entry': {
    ...
    def test_05_tax_base_amount(self):
        self._run_test({
            'payment_methods': self.cash_pm2,
            'orders': [
                {'product_quantity_pairs': [(self.product7, 7)], 'uid': '00100-010-0001'},
            ],
            'journal_entries_before_closing': {},
            'journal_entries_after_closing': {
                'session_journal_entry': {
