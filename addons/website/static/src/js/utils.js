...
const { loadAnchors, autocompleteWithPages } = require('web_editor.utils');
// TODO [15.1] remove this and update any files that need one of these
// functions so that they require them from website utils.
