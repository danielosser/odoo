...
class Base(models.AbstractModel):
    ...
    def search_panel_select_range(self, field_name):
        ...
        fields = ['display_name']
        parent_fields = Comodel._fields.get(Comodel._parent_name)
        parent_name = Comodel._parent_name if parent_fields and parent_fields.comodel_name == Comodel._name else False
        if parent_name:
