...
class Pricelist(models.Model):
    ...
    def get_products_price(self, products, quantity, uom=None, date=False):
    ...
    def get_product_price(self, product, quantity, uom=None, date=False):
    ...
    def get_product_price_rule(self, product, quantity, uom=None, date=False):
    ...
    def price_get(self, product, qty):
    ...
    def _compute_base_price(self, product, quantity, uom, date):
        ...
        if rule_base == 'pricelist' and self.base_pricelist_id:
            price = self.base_pricelist_id._compute_price_rule(
                product, quantity, uom, date)[product.id][0]  # TDE: 0 = price, 1 = rule
            src_currency = self.base_pricelist_id.currency_id
        elif rule_base == "standard_price":
            src_currency = product.cost_currency_id
            price = product.price_compute(rule_base, uom=uom)[product.id]
        else: # lst_price
