...
export class ThreadView extends Component {
    ...
    _onClickCaptureGlobal(ev) {
        if (this.threadView.messageReactionsSummaryView &&
            this.threadView.messageReactionsSummaryView.messageReactionsSummary.component &&
            this.threadView.messageReactionsSummaryView.messageReactionsSummary.component.el.contains(ev.target)) {
            return;
        }
