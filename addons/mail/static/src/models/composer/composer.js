...
function factory(dependencies) {
    ...
    class Composer extends dependencies['mail.model'] {
        ...
        _computeCanPostMessage() {
            if (this.thread && !this.textInputContent && this.pendingMessage.attachments.length === 0) {
                return false;
            }
        ...
        _computeHasUploadingAttachment() {
            return this.pendingMessage.attachments.some(attachment => attachment.isUploading);
        }
    ...
    Composer.fields = {
        ...
        pendingMessage: one2one('mail.pending_message', {
