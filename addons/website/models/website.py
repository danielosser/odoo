...
class Website(models.Model):
    ...
    def get_theme_snippet_lists(self, theme_name):
        return {
            **load_manifest('theme_default').get('snippet_lists', {}),
            **load_manifest(theme_name).get('snippet_lists', {})
        }
    ...
    def configurator_recommended_themes(self, industry_id, palette):
        ...
        client_themes_img = {t: load_manifest(t).get('images_preview_theme', {}) for t in client_themes}
