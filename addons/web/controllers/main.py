...
from odoo.modules import get_resource_path, module, load_manifest
...
class WebClient(http.Controller):
    ...
    def bootstrap_translations(self, mods=None):
        ...
        for addon_name in mods:
            manifest = load_manifest(addon_name)
            if manifest and manifest.get('bootstrap'):
                f_name = os.path.join(manifest['addons_path'], addon_name, 'i18n', f'{lang}.po')
