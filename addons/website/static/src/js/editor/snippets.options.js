...
options.Class.include({
    ...
    _computeWidgetState: async function (methodName, params) {
        switch (methodName) {
            case 'customizeWebsiteViews': {
                return this._getEnabledCustomizeValues(params.possibleValues, "ir.ui.view");
            }
            ...
            case 'customizeWebsiteAssets': {
                return this._getEnabledCustomizeValues(params.possibleValues, "ir.asset");
            }
        }
    ...
    _customizeWebsite: async function (previewMode, widgetValue, params, type) {
        ...
        switch (type) {
            case 'views':
                await this._customizeWebsiteData(widgetValue, params, "ir.ui.view");
                break;
            case 'variable':
            ...
            case 'color':
                ...
                break;
            case 'assets':
                await this._customizeWebsiteData(widgetValue, params, "ir.asset");
                break;
            default:
    ...
    _customizeWebsiteViews: async function (xmlID, params) {
        this._customizeWebsiteData(xmlID, params, "ir.ui.view");
    },
    /**
     * @private
     */
    async _customizeWebsiteData(value, params, model) {
     ...
     * @returns {String}
     */
    async _getEnabledCustomizeValues(possibleValues, model) {
