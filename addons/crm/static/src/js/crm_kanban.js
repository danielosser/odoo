/** @odoo-module **/
    ...
    const CrmKanbanColumnProgressBar = KanbanColumnProgressBar.extend({
        ...
        start() {
            ...
            if (this.showRecurringRevenue) {
                ...
                this.$('.o_kanban_counter_progress').addClass('o_crm_kanban_counter_progress_mrr');
            ...
            if (this.showRecurringRevenue) {
                ...
                if (startMRR !== undefined && (endMRR > startMRR || this.activeFilter.value) && this.ANIMATE) {
                    $({currentValue: startMRR}).animate({currentValue: endMRR}, {
                        ...
                        step: function () {
                            self.$recurringRevenueNumber.html(utils.human_number(this.currentValue));
                        },
                        complete: function () {
                            self.$recurringRevenueNumber.html(utils.human_number(this.currentValue));
                    ...
                    this.$recurringRevenueNumber.html(utils.human_number(endMRR));
                }
            }
        },
    ...
    const CrmKanbanColumn = KanbanColumn.extend({
        init: function (parent, data, options, recordOptions) {
            options.KanbanColumnProgressBar = CrmKanbanColumnProgressBar;
            this._super.apply(this, arguments);
        },
    });
