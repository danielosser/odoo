...
class SaleOrder(models.Model):
    ...
    def _compute_option_data_for_template_change(self, option):
        ...
        if self.pricelist_id:
            pricelist_price = self.pricelist_id.with_context(uom=option.uom_id.id).get_product_price(option.product_id, 1)
    ...
    def update_prices(self):
        ...
        for line in self.sale_order_option_ids:
            line.price_unit = self.pricelist_id.get_product_price(line.product_id, line.quantity, uom=line.uom_id)
        return res
    ...
    def onchange_sale_order_template_id(self):
        ...
        for line in template.sale_order_template_line_ids:
            ...
            if line.product_id:
                ...
                if self.pricelist_id:
                    pricelist_price = self.pricelist_id.with_context(uom=line.product_uom_id.id).get_product_price(line.product_id, 1)
