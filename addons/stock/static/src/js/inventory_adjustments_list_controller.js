odoo.define('stock.InventoryAdjustmentsListController', function (require) {
    "use strict";
    ...
    var InventoryAdjustmentsListController = InventoryReportListController.extend({
    
        buttons_template: 'StockInventoryAdjustments.Buttons',
    ...
    return InventoryAdjustmentsListController;
