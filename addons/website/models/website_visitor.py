...
class WebsiteVisitor(models.Model):
    ...
    parent_id = fields.Many2one('website.visitor', string="Parent", ondelete='set null', help="Main identity")
    ...
    def _cron_clean_inactive_visitors(self):
    ...
    def _inactive_visitors_domain(self):
        """ This method defines the domain of visitors that can be cleaned.
        By default, visitors that are not linked to a partner and that have not been active for
        'website.visitor.live.days' (default 30) days are considered inactive.
