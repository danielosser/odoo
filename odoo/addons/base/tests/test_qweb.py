    ...
    def test_call_1(self):
        ...
        view1 = self.env['ir.ui.view'].create({
            ...
            'arch': """
                <t t-name="base.other">
                    <div>
                        <t t-call="base.dummy" t-arg="{'a': 1}" t-arg-b="2"/>
                    </div>
                </t>
            """
        })
        ...
        """), 'render t-call with t-arg attributes')
            ...
            'arch': """
                <t t-name="template_header">
                    <header>
                        ...
                        <t t-call="base.template_menu" t-arg-title="val">
                            <t t-out="0"/>
                            header text
                        </t>
                    </header>
        ...
        template_page = self.env['ir.ui.view'].create({
            ...
            'arch': """
                <t t-name="template_page">
                    <t t-call="base.template_layout">
                        <page t-cache="page_cache_id">
                            <t t-call="base.template_header" t-arg-title="template_page_record_title">
