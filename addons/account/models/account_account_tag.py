...
class AccountAccountTag(models.Model):
    ...
    tax_report_expression_ids = fields.Many2many(string="Tax Report Expressions", comodel_name='account.report.expression', relation='account_report_expression_tags_rel', help="The report expressions using this tag")
