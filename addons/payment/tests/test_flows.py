...
class TestFlows(PaymentCommon, PaymentHttpCommon):
    ...
    def _test_flow_only_one_payment_request(self, flow):
        with patch.object(PaymentTransaction, '_send_payment_request') as patched:
            self.env['payment.transaction']._send_payment_request()
    ...
    def test_10_direct_checkout_public(self):
        ...
        self._test_flow_only_one_payment_request('direct')
